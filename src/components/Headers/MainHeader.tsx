        ...
        <header className="sticky top-0 z-30">
                ...
                <div className="2xl:px-32 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-x-5 w-full lg:w-auto">
                            ...
                            <div
                                className="bg-zinc-100 rounded-lg py-3 flex items-center gap-x-4 w-full lg:pl-80 xl:pl-96 pr-4 mx-4 lg:mx-0">
                                <svg
            ...
            >
                <div className="2xl:px-32">
                    <div className="hidden lg:flex items-center justify-between py-3 sticky top-20">
                        <div className="flex items-center gap-x-4">
                            ...
                            <Link href={"/"} className="flex items-center gap-x-2 text-sm">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <path
                                            d="M5 5.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m4 4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1"/>
                                    </g>
                                </svg>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M.5 11a1 1 0 0 0 .998 1h11.004a1 1 0 0 0 .998-1V8.966a2.037 2.037 0 0 1 0-3.932V3a1 1 0 0 0-.998-1H1.498A1 1 0 0 0 .5 3v2.03a2.037 2.037 0 0 1 0 3.94zm4.02-1.5l5-5"/>
                                        <path
                                            d="M5.02 5.5a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1m4 4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1"/>
                                    </g>
                                </svg>
                        ...
                        <button
                            className="text-xs flex items-center gap-x-2 bg-orange-50 text-orange-500 rounded-full py-2 px-3">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="1.5em"
                                height="1.5em"
